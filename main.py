...
class Window(Frame):
    ...
    def init_window(self):
        ...
        # Ten truong
        city_name = Label(window, text='Da Nang City', fg ="black", \
                    bg= None, relief= None, font =("arial", 10, "bold"))
        city_name.place(x= 1100, y=150)
        school_name = Label(window, text='VietNam Korea University', fg ="black", \
                    bg= None, relief= None, font =("arial", 10, "bold"))
        school_name.place(x= 1100, y=170)

        # Chen thong tin ca nhan
        name = Label(window, text='Group: Buu Khanh & Anh Khoa', fg ="black", \
                    bg= None, relief= None, font =("arial", 12, "bold"))
        name.place(x= 1100, y=190)
        id_student = Label(window, text='ID: 18IT279 18IT280', fg ="black", \
                    bg= None, relief= None, font =("arial", 12, "bold"))
        id_student.place(x= 1100, y=210)
        year = Label(window, text='K2018', fg ="black", \
                    bg= None, relief= None, font =("arial", 12, "bold"))
